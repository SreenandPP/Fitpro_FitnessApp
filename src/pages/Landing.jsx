         ...
         <section id='about'>
            ...
            <div className='mt-5 p-5 w-100'>
               <div className='text-center text-white'>
                  ...
                  <div  className='mt-1 responsive-container '>
            ...
            <div className='w-100 mt-3 '>
               ...
               <div className='mt-3 p-5 '>
                  ...
                  <div class="col-12 col-sm-6 col-md-4 d-flex justify-content-center">
                     <Link to={'/workouts'}>
                        <div className="card card-custom" style={{ width: '18rem', backgroundColor: '#ff6c05', borderRadius: '5px' }}>
                     ...
                     <div className="card card-custom" style={{ width: '18rem', backgroundColor: '#fff', borderRadius: '5px', border: 'none' }}>
                     ...
                     <div className="card card-custom" style={{ width: '18rem', backgroundColor: '#fce7b0', borderRadius: '5px' }}>

            ...
            <Row>
                ...
                <Col sm={12} md={6}>
                    ...
                    <div className='mt-3 d-flex justify-content-between'>
                        ...
                        {status ?
                            <button className='btn rounded' onClick={handleLogin} style={{ backgroundColor: 'var(--dark-red)', color: 'white', textDecoration: 'none', fontWeight: '200' }} >
                            ...
                            <button className='btn rounded' style={{ backgroundColor: 'var(--dark-red)', color: 'white', textDecoration: 'none', fontWeight: '200' }} onClick={handleRegister} >
